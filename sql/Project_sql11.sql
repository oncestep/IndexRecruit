...
INSERT INTO `admin` VALUES (19980208,'17806228320','9136f8f230e20ca9afc410d14c826586','管理员','lb19961218@163.com');
...
INSERT INTO `application` VALUES (1,1,NULL,1,1,1),(2,1,NULL,2,5,2),(3,1,NULL,2,11,2),(4,1,NULL,2,15,3),(5,1,NULL,6,11,5),(6,1,NULL,5,3,3),(7,1,NULL,6,18,1),(8,1,NULL,4,5,1),(9,1,NULL,4,13,6),(10,0,'2017-11-09 12:57:37',16,1,NULL),(11,0,'2017-11-16 15:10:26',16,6,NULL);
...
INSERT INTO `comment` VALUES (1,3,'C++是C语言的继承，它既可以进行C语言的过程化程序设计，又可以进行以抽象数据类型为特点的基于对象的程序设计，还可以进行以继承和多态为特点的面向对象的程序设计','2017-11-14 22:47:42',1,5),(2,2,'Java是一门面向对象编程语言，不仅吸收了C++语言的各种优点，还摒弃了C++里难以理解的多继承、指针等概念','2017-11-14 22:47:42',1,17),(3,1,'Python是纯粹的自由软件， 源代码和解释器CPython遵循 GPL(GNU General Public License)协议','2017-11-14 22:47:42',2,11),(4,3,'C++不仅拥有计算机高效运行的实用性特征，同时还致力于提高大规模程序的编程质量与程序设计语言的问题描述能力','2017-11-14 22:47:42',3,18),(5,3,'这是一些关于Java工程师的评论，这个职位需要丰富的阅历的和工作经验','2017-11-14 22:47:42',5,2),(6,2,'又要写测试评论，写点啥呢？布吉岛','2017-11-14 22:47:42',6,8),(7,3,'数据挖掘一般是指从大量的数据中通过算法搜索隐藏于其中信息的过程','2017-11-14 22:47:42',6,14),(8,3,'Java具有简单性、面向对象、分布式、健壮性、安全性、平台独立与可移植性、多线程、动态性等特点','2017-11-14 22:47:42',6,17),(9,2,'Python 已经成为最受欢迎的程序设计语言之一','2017-11-14 22:47:42',1,10),(10,3,'.NET是 Microsoft XML Web services 平台','2017-11-14 22:47:42',2,9),(13,1,'评论一哈。。。PHP是最好的编程语言！','2017-11-14 22:47:42',16,7),(14,2,'Java是面向对象的编程语言，而其AOP机制面向切面编程，弥补了Java本身的缺点','2017-11-14 22:51:06',16,1),(16,3,'数据挖掘指通过挖掘算法发现隐藏在大量数据中的有价值信息点','2017-11-15 20:45:33',16,15),(17,3,'评论一哈~','2017-11-16 15:10:15',16,6),(18,2,'对Python职位的一点评论。。。','2017-11-16 17:09:35',16,12);
...
INSERT INTO `position` VALUES (1,'Java工程师','熟练使用RPC框架，具备相关的分布式开发经验',3,'北京市',12000,7000,'2017-10-27',NULL,1,136,1,1,1),(2,'Java工程师','接收应届实习生，实习期满应聘上岗接收应届实习生，实习期满应聘上岗收应届实习生，实习期满应聘上岗',5,'上海市',16000,11000,'2017-11-07',NULL,1,108,1,4,2),(3,'Java工程师','有扎实的java基础，熟悉分布式、缓存、异步消息等原理和应用',15,'天津市',13000,10000,'2017-09-30',NULL,1,3,1,7,3),(4,'Java工程师','JAVA WEB方向2年+经验',2,'南京市',16000,12000,'2017-09-25',NULL,1,7,1,10,4),(5,'C++工程师','可接收计算机相关专业应届生，表现优秀者加薪转正',30,'南京市',8000,5000,'2017-10-16',NULL,1,13,2,10,4),(6,'C++工程师','3-5年工作经验，计算机相关专业毕业',1,'上海市',16000,8000,'2017-11-03',NULL,1,4,2,4,2),(7,'PHP工程师','一年以上PHP开发经验 （项目经验丰富的，也可以升级为高级开发工程师）',10,'上海市',11000,8000,'2017-11-10',NULL,1,71,3,4,2),(8,'PHP工程师','熟悉LNMP/WNMP开发环境 , 熟练使用Yaf, Yii, ThinkPHP等一种或多种框架',5,'上海市',12000,7000,'2017-11-01',NULL,1,1,3,4,2),(9,'.NET工程师','熟悉WinForm/WPF窗体开发并有实际项目经验',2,'北京市',13000,11000,'2017-11-02',NULL,1,1,4,1,1),(10,'Python数据分析','熟练使用Linux，可以快速上手编写shell、powershell、cmd等操作系统脚本',2,'北京市',23000,18000,'2017-10-09',NULL,1,42,5,1,1),(11,'Python开发','4年以上互联网产品后台研发经验，2年以上后台构架经验',2,'北京市',22000,18000,'2017-09-23',NULL,1,0,5,1,1),(12,'Python开发','精通Python，2年或以上Python项目经验',3,'天津市',16000,14000,'2017-07-27',NULL,1,31,5,7,3),(13,'数据挖掘工程师','熟悉 Linux平台上的编程环境，精通Java开发，精通 Python/Shell等脚本语言',12,'天津市',22000,15000,'2017-11-05',NULL,1,1,6,7,3),(14,'数据挖掘工程师','熟悉Hadoop、Hive、Spark、流式计算、实时计算等大数据相关技术者优先，熟悉时序挖掘、文本挖掘、网络挖掘等优先',2,'北京市',32000,28000,'2017-11-06',NULL,1,4,6,1,1),(15,'数据挖掘工程师','精通Python，熟悉PHP/GO/Java/C++/C等语言中的一种或几种',2,'杭州市',26000,14000,'2017-11-08',NULL,1,19,6,13,5),(16,'Java工程师','熟悉Spring、Freemark、Struts、Hibernate 等开源框架',13,'杭州市',18000,15000,'2017-11-11',NULL,1,4,1,17,6),(17,'Java后端开发','熟练使用Mybatis，SpringMVC，SpringCloud等框架',5,'杭州市',21000,18000,'2017-10-23',NULL,1,3,1,13,5),(18,'C++后端开发','熟练linux系统操作，熟练gcc,gdb,vim, eclipse等开发工具',5,'北京市',12000,9000,'2017-10-28',NULL,1,0,2,1,1);
...
INSERT INTO `resume` VALUES (1,NULL,NULL,NULL,NULL,NULL,1),(2,NULL,NULL,NULL,NULL,NULL,2),(3,NULL,NULL,NULL,NULL,NULL,3),(4,NULL,NULL,NULL,NULL,NULL,4),(5,NULL,NULL,NULL,NULL,NULL,5),(6,NULL,NULL,NULL,NULL,NULL,6),(7,NULL,NULL,NULL,NULL,NULL,7),(8,NULL,NULL,NULL,NULL,NULL,8),(9,NULL,NULL,NULL,NULL,NULL,9),(10,NULL,NULL,NULL,NULL,NULL,10),(11,NULL,NULL,NULL,NULL,NULL,11),(12,NULL,NULL,NULL,NULL,NULL,12),(13,NULL,NULL,NULL,NULL,NULL,13),(14,NULL,NULL,NULL,NULL,NULL,14),(16,'能力很强，测试一哈；','有六个月实习经历，测试一哈；','无工作经历，测试一哈；','有几次的奖学金，测试一哈；','一份相对稳定的工作，测试一哈；',16),(17,NULL,NULL,NULL,NULL,NULL,17),(21,NULL,NULL,NULL,NULL,NULL,21);
...
-- Dump completed on 2017-11-16 17:17:38
